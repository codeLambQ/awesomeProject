...
const file_lesson_proto_rawDesc = "" +
	"\n" +
	"\flesson.proto\x12\x04main\x1a\x1cgoogle/api/annotations.proto\"D\n" +
	"\x06Lesson\x12\x0e\n" +
	...
	"\rLessonService\x12B\n" +
	"\tGetLesson\x12\x0e.main.LessonId\x1a\f.main.Lesson\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/getLesson/{id}B\bZ\x06./mainb\x06proto3"
...
var file_lesson_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_lesson_proto_goTypes = []any{
	(*Lesson)(nil),   // 0: main.Lesson
	(*LessonId)(nil), // 1: main.LessonId
}
var file_lesson_proto_depIdxs = []int32{
	1, // 0: main.LessonService.GetLesson:input_type -> main.LessonId
	0, // 1: main.LessonService.GetLesson:output_type -> main.Lesson
