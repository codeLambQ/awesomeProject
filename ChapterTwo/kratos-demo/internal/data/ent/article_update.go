...
func (_u *ArticleUpdate) SetContext(v string) *ArticleUpdate {
	_u.mutation.SetContext(v)
	return _u
}

// SetNillableContext sets the "context" field if the given value is not nil.
func (_u *ArticleUpdate) SetNillableContext(v *string) *ArticleUpdate {
	if v != nil {
		_u.SetContext(*v)
	}
	return _u
...
// SetContext sets the "context" field.
func (_u *ArticleUpdateOne) SetContext(v string) *ArticleUpdateOne {
	_u.mutation.SetContext(v)
	return _u
}

// SetNillableContext sets the "context" field if the given value is not nil.
func (_u *ArticleUpdateOne) SetNillableContext(v *string) *ArticleUpdateOne {
	if v != nil {
		_u.SetContext(*v)
	}
	return _u
