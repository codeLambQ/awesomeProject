...
func (m *ArticleMutation) SetContext(s string) {
	m.context = &s
}

// Context returns the value of the "context" field in the mutation.
func (m *ArticleMutation) Context() (r string, exists bool) {
	v := m.context
	if v == nil {
		return
	}
...
// OldContext returns the old "context" field's value of the Article entity.
// If the Article object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ArticleMutation) OldContext(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ArticleMutation) ResetContext() {
	m.context = nil
}
...
func (m *ArticleMutation) Fields() []string {
	...
	if m.context != nil {
		fields = append(fields, article.FieldContext)
	}
	if m.created_at != nil {
